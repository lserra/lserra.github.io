...
FEED_DOMAIN = SITEURL
HTTPS = True
SITENAME = 'datasecops.io'
SITETITLE = 'data-sec-ops'
SITESUBTITLE = 'Cloud, Security, Data and AI'
SITEDESCRIPTION = 'Ideias e reflexões sobre cloud, segurança, dados e inteligência artificial'
